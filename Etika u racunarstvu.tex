...
& \includegraphics[scale=.2]{slike/aristotel.jpg} & \includegraphics[scale=.2]{slike/kant.jpg} & \includegraphics[scale=.2]{slike/mil.jpg} \\
\hline
\end{tabular}
\label{tab:tabela1}
...
Termin deontologija potiče od grčkih reči koje označavaju dužnost (deon) i nauku (logos) \cite{stanford}. Prema savremenoj moralnoj filozofiji, deontologija spada u domen moralnih teorija koje procenjuju moralnost postupaka(izbora), tj. procenjuje se ono sto je ispravno učiniti, pa se tako izbori mogu klasifikovati kao moralno obavezni, dozvoljeni ili zabranjeni. Za razliku od ovih teorija, etika vrline procenjuje kakva osoba bi trebalo da budemo i u skladu sa tim da delujemo.
